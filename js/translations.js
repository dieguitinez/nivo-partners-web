const translations = {
    en: {
        ...
        ai: {
            hero: {
                ...
                subtitle: "Automate your text, data, and email workflows. We build systems that run your business on autopilot.",
                cta: "View Automation Products"
            },
            products: {
                title: "Business <span class='text-gradient'>Process Automation</span>",
                subtitle: "High-leverage systems for zero-operational-cost growth."
            },
            tier1: {
                title: "Review Management",
                tag: "Reputation",
                desc: "Turn reviews into revenue. Our AI monitors your Google Profile 24/7 and drafts professional, SEO-optimized responses to every customer instantly."
            },
            tier2: {
        ...
        caseStudy: {
            ...
            title: "Scaling <span class='text-gradient'>Sun Air Shades</span>",
            desc: "Helping a Florida-based Smart Home contractor dominate their local market through revenue engineering.",
            metric1: "+63%",
            label1: "Lead Volume",
            metric2: "21%",
            label2: "Close Rate (from 12%)",
            metric3: "$29k",
            label3: "Monthly Revenue Run Rate"
        },
        comparison: {
            ...
            wizard: {
                ...
                steps: {
                    step1: {
                        ...
                        options: [
                            { id: "ecommerce", label: "eCommerce", detail: "High-Volume Sales" },
                            { id: "portfolio", label: "Portfolio", detail: "Market Authority" },
                            { id: "corporate", label: "Corporate", detail: "Enterprise Trust" },
                            { id: "landing", label: "Landing Page", detail: "Rapid Conversion" }
                        ]
                    },
                    step2: {
                ...
                generating: "Generating your custom infrastructure architecture...",
    ...
    es: {
        ...
        ai: {
            hero: {
                badge: "Automatización de Procesos de Negocio",
                title: "Deje de Alquilar Labor. Comience a Poseer <span class='text-gradient'>Eficiencia</span>.",
                subtitle: "Automatice sus flujos de texto, datos y correo. Construimos sistemas que ejecutan su negocio en piloto automático.",
                cta: "Ver Productos de Automatización"
            },
            products: {
                title: "<span class='text-gradient'>Automatización de Procesos</span>",
        ...
        caseStudy: {
            badge: "Caso de Éxito Destacado",
            title: "Escalando <span class='text-gradient'>Sun Air Shades</span>",
            desc: "Ayudando a un contratista de Smart Home en Florida a dominar su mercado local mediante ingeniería de ingresos.",
            metric1: "+63%",
            label1: "Volumen de Leads",
            metric2: "21%",
            label2: "Tasa de Cierre (de 12%)",
            metric3: "$29k",
            label3: "Revenue Mensual (Run Rate)"
        },
        comparison: {
        ...
        webPage: {
            ...
            wizard: {
                ...
                steps: {
                    step1: {
                        q: "¿Cuál es el motor de ingresos principal de su negocio?",
                        options: [
                            { id: "ecommerce", label: "eCommerce", detail: "Ventas de Alto Volumen" },
                            { id: "portfolio", label: "Portafolio", detail: "Autoridad de Mercado" },
                            { id: "corporate", label: "Corporativo", detail: "Confianza Empresarial" },
                            { id: "landing", label: "Landing Page", detail: "Conversión Rápida" }
                        ]
                    },
                    step2: {
                ...
                generating: "Generando su arquitectura de infraestructura personalizada...",
